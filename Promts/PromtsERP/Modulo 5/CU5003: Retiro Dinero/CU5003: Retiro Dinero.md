...
Presentar un Grid editable llamado "vDetalleRetiro" que permita agregar, borrar y editar lineas.
vEtiquetasRetiro = Llamada SP: `get_etiquetas_retiro()` (devuelve campo_visible)
Campos devueltos: `codigoetiquetaretiro`, `nombre`
Variables:
vcodigoetiquetaretiro no visible editable
vnombre_etiquetaretiro visible no editable

El Grid debe tener las siguientes columnas: vcodigoetiquetaretiro, vnombre_etiquetaretiro, vmonto.
