...
- Guardar los mismos logs en archivo por ejecucion dentro de `wizard/Modulo 3/CU3-002/logs/`.
- El archivo debe nombrarse `CU3-002-YYYYMMDD-HHMMSS-001.log` (incrementar el sufijo si ya existe).
...
- Registrar ajuste bancario (AJC)

# **Pasos del formulario-multipaso.

1. Registrar Ajuste Bancario (AJC).
...
Paso 1. Registrar Ajuste Bancario (AJC).
...
vMonto = Monto del ajuste (permitir positivo o negativo). Campo editable.
...
Mostrar resumen del ajuste y la cuenta seleccionada.
