...
Mostrar un Grid llamado "vProveedoresPendientes" que llama al siguiente SP: `get_proveedores_saldos_pendientes()` (devuelve campo_visible)
Campos devueltos: `codigo_provedor`, `nombre`, `saldo_final`
Variables:
