...
- Crear Fabricacion de Movimiento de Stock.

# **Pasos del formulario-multipaso.

1. Crear Fabricacion de Movimiento de Stock.
...
Paso 1  Crear Fabricacion de Movimiento de Stock.
...
Presentar un Grid editable llamado “vDetalleConsumo” que permita agregar, borrar y editar lineas. El Grid debe tener las siguientes columnas: codigo_producto, cantidad.

Presentar un Grid editable llamado “vDetalleFabricado” que permita agregar, borrar y editar lineas. El Grid debe tener las siguientes columnas: codigo_producto, cantidad.

Para la columna codigo_producto ofrecer la lista de productos que devuelve el SP get_productos.

Crear Fabricacion de Movimiento de Stock. Al terminar el formulario multipasos, cuando el usuario da click al boton “Crear Fabricacion” el sistema debera realizar las siguientes transacciones sobre la DB:

- Guardar en la tabla “movimiento_stock”. vTipo_documento, vNum_documento, vFecha, vCodigo_base.

- Guardar en la tabla “detalle_movimiento_stock” los datos del grid “vDetalleConsumo” con la cantidad en negativo.

- Guardar en la tabla “detalle_movimiento_stock” los datos del grid “vDetalleFabricado” con la cantidad en positivo.
