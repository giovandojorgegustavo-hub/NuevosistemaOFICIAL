...
# **Prompt AI.
Modulo: 2.
Caso de uso: CU2002 - M2Empacar.
Puerto del wizard: 3010 (ver `Promts/Herramientas/puertos.json`).
...
mostrar un resumen 
Al dar click en "Empacar" el sistema debera realizar las siguientes transacciones sobre la DB (llamadas directas a SPs/INSERT):
