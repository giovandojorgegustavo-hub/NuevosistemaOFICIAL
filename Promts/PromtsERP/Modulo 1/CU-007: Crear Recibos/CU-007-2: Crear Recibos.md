...
- Guardar los mismos logs en archivo por ejecucion dentro de `wizard/Modulo 1/CU-007/logs/`.
...
Cargar un Grid llamado "vClientesPendientes" con las tuplas devueltas por el SP `get_clientes_saldo_pendiente()` (solo mostrar saldo_final > 0).

Columnas visibles del Grid:
- vNombreCliente=nombre
