...
# **Prompt AI.
Modulo: 1.
Caso de uso: CU003 - M1EnPaquetesCamino.
Puerto del wizard: 3003 (ver `Promts/Herramientas/puertos.json`).
...
Gestionar estado de paquetes en camino
...
1. Seleccion de paquete en camino.
...
Paso 1. Seleccion de paquete en camino.
...
El usuario podra seleccionar uno o varios paquetes.
Si selecciona uno: pasar al Paso 2.
Si selecciona varios: habilitar boton \"Accion masiva\" y pasar directo al Paso 3.


Paso 2. Mostrar informacion de un paquete (solo lectura, solo si se selecciono 1).
