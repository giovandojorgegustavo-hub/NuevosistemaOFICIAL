...
- Crear Transferencia de Movimiento de Stock.

# **Pasos del formulario-multipaso.

1. Crear Transferencia de Movimiento de Stock.
...
Paso 1  Crear Transferencia de Movimiento de Stock.
...
Presentar un Grid editable llamado “vDetalleTransferencia” que permita agregar, borrar y editar líneas. El Grid debe tener las siguientes columnas: codigo_producto, cantidad.

Para la columna codigo_producto ofrecer la lista de productos que devuelve el SP get_productos.

Crear Transferencia de Movimiento de Stock. Al terminar el formulario multipasos, cuando el usuario da click al boton “Crear Transferencia” el sistema deberá realizar las siguientes transacciones sobre la DB:

- Guardar en la tabla “movimiento_stock”. vTipo_documento, vNum_documento, vFecha, vCodigo_base, vCodigo_basedestino.

- Guardar en la tabla “detalle_movimiento_stock” los datos del grid “vDetalleTransferencia”.
